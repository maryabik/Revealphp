...
<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <form method="post" action="addvid.php"  enctype="multipart/form-data">
    <body class="bg-dark">
  <div class="container">
      ...
      <div class="card-body">
        <form>
          <div class="form-group">
            ...
            <input class="form-control" id="exampleInputEmail2" type="text" aria-describedby="emailHelp" placeholder="Enter Title" name="tname" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="exampleInputEmail4" type="text" aria-describedby="nameHelp" name="summary" required>
          </textarea>
          </div>
          <div class="form-group">
            <div class="form-row">
