      ...
      <div class="card-body">
        <form>
          <div class="form-group">
            ...
            <input class="form-control" id="exampleInputEmail2" type="text" aria-describedby="emailHelp" placeholder="Enter Title" name="title" required>
          </div>
          <div class="form-group">
            <label for="exampleInputEmail2"  style="color:#3a87ad;">Full Name</label>
            <input class="form-control" id="exampleInputEmail2" type="text" aria-describedby="emailHelp" placeholder="Enter Title" name="fname" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="exampleInputEmail4" type="text" aria-describedby="nameHelp" name="statement" required>
          </textarea>
          </div>
          <div class="form-group">
            <div class="form-row">
